...
Vagrant.configure("2") do |config|
  ...
  # config.vm.synced_folder "output", "/vagrant_data"
  ...
  config.vm.provision "shell", inline: <<-SHELL
    ...
    echo udp_tunnel      > /etc/modules-load.d/tunnel.conf
    echo ip_tunnel      >> /etc/modules-load.d/tunnel.conf
    echo ip6_tunnel     >> /etc/modules-load.d/tunnel.conf
    echo ip6_udp_tunnel >> /etc/modules-load.d/tunnel.conf
  SHELL
end
